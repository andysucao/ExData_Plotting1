...
plot(data2$time, data2$globalactivepower, type = "n",main = "", xlab = "", ylab = "Global Active Power")
lines(data2$time, data2$globalactivepower)


plot(data2$time, data2$voltage, type = "n",main = "", xlab = "datetime", ylab = "Voltage")
...
plot(data2$time, data2$globalreactivepower, type = "n",main = "", xlab = "datetime", ylab = "Global_reactive_power")
lines(data2$time, data2$globalreactivepower)
